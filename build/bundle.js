...
var app = (function () {
    ...
    function create_if_block_1(ctx) {
    	let div;
    	let p;
    	let t_value = JSON.stringify(/*json*/ ctx[0]) + "";
    	let t;
    	let p_transition;
    	let current;
    	...
    	const block = {
    		c: function create() {
    			...
    			p = element("p");
    			t = text(t_value);
    			attr_dev(p, "class", "svelte-2hs34v");
    			add_location(p, file$2, 13, 8, 400);
    			attr_dev(div, "class", "column svelte-2hs34v");
    			add_location(div, file$2, 12, 4, 370);
    		},
    		m: function mount(target, anchor) {
    		...
    		p: function update(ctx, dirty) {
    			if ((!current || dirty & /*json*/ 1) && t_value !== (t_value = JSON.stringify(/*json*/ ctx[0]) + "")) set_data_dev(t, t_value);
    		},
    ...
    // (6:0) {#if json && "data" in json && "items" in json.data && json.data.items.length > 0}
    function create_if_block(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			attr_dev(div, "class", "column svelte-2hs34v");
    			add_location(div, file$2, 6, 4, 198);
    		},
    		m: function mount(target, anchor) {
    			insert_dev(target, div, anchor);
    	...
    	dispatch_dev("SvelteRegisterBlock", {
    		...
    		type: "if",
    		source: "(6:0) {#if json && \\\"data\\\" in json && \\\"items\\\" in json.data && json.data.items.length > 0}",
    		ctx
    	});
    ...
    // (8:8) {#each json.data.items as item}
    function create_each_block(ctx) {
    	let p;
    	let t_value = JSON.stringify(/*item*/ ctx[1]) + "";
    	let t;
    	let p_transition;
    	let current;
    	...
    	const block = {
    		c: function create() {
    			...
    			t = text(t_value);
    			attr_dev(p, "class", "svelte-2hs34v");
    			add_location(p, file$2, 8, 12, 273);
    		},
    		m: function mount(target, anchor) {
    		...
    		p: function update(ctx, dirty) {
    			if ((!current || dirty & /*json*/ 1) && t_value !== (t_value = JSON.stringify(/*item*/ ctx[1]) + "")) set_data_dev(t, t_value);
    		},
    		i: function intro(local) {
    			if (current) return;
    	...
    	dispatch_dev("SvelteRegisterBlock", {
    		...
    		type: "each",
    		source: "(8:8) {#each json.data.items as item}",
    		ctx
    	});
    ...
    function create_fragment$2(ctx) {
    	...
    	function select_block_type(ctx, dirty) {
    		if (/*json*/ ctx[0] && "data" in /*json*/ ctx[0] && "items" in /*json*/ ctx[0].data && /*json*/ ctx[0].data.items.length > 0) return 0;
    		if (/*json*/ ctx[0]) return 1;
    		return -1;
    	}
    ...
    function instance$2($$self, $$props, $$invalidate) {
    	...
    	$$self.$capture_state = () => ({ json, fly, fade, slide, draw });
    ...
    function create_fragment$1(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			form = element("form");
    			input = element("input");
    			attr_dev(input, "class", "svelte-1n294s2");
    			add_location(input, file$1, 26, 8, 658);
    			attr_dev(form, "class", "svelte-1n294s2");
    			add_location(form, file$1, 21, 4, 547);
    			attr_dev(div, "class", "row svelte-1n294s2");
    			add_location(div, file$1, 20, 0, 524);
    		},
    		l: function claim(nodes) {
    ...
    function create_pending_block(ctx) {
    	...
    	dispatch_dev("SvelteRegisterBlock", {
    		...
    		type: "pending",
    		source: "(11:21)          <Spinner />     {:then result}",
    		ctx
    	});
    ...
    function create_fragment(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			t = space();
    			info.block.c();
    			attr_dev(main, "class", "svelte-1021l6h");
    			add_location(main, file, 7, 0, 193);
    		},
    		l: function claim(nodes) {
    			throw new Error("options.hydrate only works if the component was compiled with the `hydratable: true` option");
    		},
